...
export const catechumenLessons: CatechumenLesson[] = [
  ...
  {
    id: 17,
    title: "The Sacrament of the Unction of the Sick",
...
export const catechumenLessonRecaps: Record<string, string[]> = {
  ...
  "sacrament-of-priesthood": [
    ...
    "The lesson argues from Scripture that Christ set apart ministers and that bishops, priests, and deacons have distinct duties.",
    "It explains ordination, grace, the degrees of ministry, and the obligations of clergy before and after ordination.",
  ],
...
export const catechumenMemoryVerses: Record<string, { reference: string; text: string }> = {
  ...
  "sacrament-of-priesthood": {
    ...
    text: "No man taketh this honour unto himself, but he that is called of God, as was Aaron.",
  },
  "sacrament-of-anointing-of-the-sick": {
...
export const catechumenLessonQuizzes: Record<string, QuizQuestion[]> = {
  "ethiopian-orthodox-tewahedo-church": [
    {
      prompt: "What does the lesson say existed in Ethiopia before Christianity was introduced?",
      options: [
        "Pagan worship and Judaism side by side",
        "Only atheism and no organized worship",
        "Only Christianity in secret",
        "Only Roman religion",
      ],
      answerIndex: 0,
      explanation: "The first section says that both paganism and Judaism were practiced in Ethiopia before the introduction of Christianity.",
    },
    {
      prompt: "How did Christianity become the state religion of Ethiopia according to the lesson?",
      options: [
        "Through the conversion of the king and the work of Frumentius",
        "By forced conquest from Rome",
        "By Portuguese missionaries in the sixteenth century",
        "By rejecting Alexandria",
      ],
      answerIndex: 0,
      explanation: "The lesson says Christianity became the state religion because it was the desire of the king, and Frumentius guided that process.",
    },
    {
      prompt: "Who was consecrated by St. Athanasius as the first Bishop of Axum?",
      options: ["St. Yared", "King Ezana", "St. Frumentius", "Abba Libanos"],
      answerIndex: 2,
      explanation: "Frumentius went to Alexandria, and Athanasius agreed that he himself should be consecrated as the first Bishop of Axum.",
    },
    {
      prompt: "What major work did the Nine Saints especially help advance in Ethiopia?",
      options: [
        "Monastic expansion, biblical translation, and Ge'ez Christian literature",
        "The abolition of the liturgy",
        "The replacement of Ge'ez by Latin",
        "The end of church music",
      ],
      answerIndex: 0,
      explanation: "The lesson highlights the Nine Saints for missionary work, monastic foundations, and the translation of Scripture and church texts into Ge'ez.",
    },
    {
      prompt: "What made the wars of Ahmad Gragn so devastating for the Ethiopian Church?",
      options: [
        "They targeted churches, monasteries, treasures, and the Christian heritage of the highlands",
        "They only affected trade routes and not the Church",
        "They ended with no destruction to church life",
        "They were mainly debates about liturgical language",
      ],
      answerIndex: 0,
      explanation: "The lesson says the invasion was especially aimed at destroying the Church and its heritage, with looting, burning, and forced conversions.",
    },
    {
      prompt: "What major change marked the period of reorganization in the twentieth century?",
      options: [
        "The Ethiopian Church moved toward autonomy and finally received an Ethiopian metropolitan",
        "The Church permanently lost all ties with Christianity",
        "The bishops stopped being consecrated altogether",
        "The Church abandoned Tewahido teaching",
      ],
      answerIndex: 0,
      explanation: "The final section explains the move toward autonomy and the eventual establishment of Ethiopian leadership with Abuna Basilios.",
    },
  ],
  "history-of-the-church": [
    {
    ...
    {
      prompt: "Why does the lesson reject the label 'Monophysite' for the Ethiopian Church?",
      options: [
        "Because the Church does not deny Christ's full humanity and divinity but confesses their inseparable union",
        "Because the Church accepts Eutyches without qualification",
        "Because the Church believes Christ has no real body",
        "Because the Church rejects St. Cyril of Alexandria",
      ],
      answerIndex: 0,
      explanation: "The lesson says the Church rejects Eutyches and confesses Christ as perfect God and perfect man in inseparable unity.",
    },
    {
      prompt: "What practical danger does the lesson see in separating Christ into two natures after the union?",
      options: [
        "It weakens the confession that the one who redeemed us is truly the Incarnate Son",
        "It makes the resurrection easier to explain",
        "It proves the Ethiopian Church is Protestant",
        "It has no effect on salvation teaching",
      ],
      answerIndex: 0,
      explanation: "The lesson argues that separating Christ after the union leads to serious problems for understanding redemption itself.",
    },
  ],
  "orthodox-creed": [
    {
    ...
    {
      prompt: "Why is the Creed more than a summary of ideas?",
      options: [
        "Because it is also prayed and confessed in the worshiping life of the Church",
        "Because it was written only for private debate",
        "Because it replaces Scripture",
        "Because it has no connection to liturgy",
      ],
      answerIndex: 0,
      explanation: "The lesson treats the Creed as both doctrine and prayer within the Church's life.",
    },
    {
      prompt: "What does the Creed confess about baptism?",
      options: [
        "One baptism for the remission of sins",
        "Many baptisms for different groups",
        "That baptism is optional symbolism only",
        "That baptism belongs only to clergy",
      ],
      answerIndex: 0,
      explanation: "The Creed directly confesses one baptism for the remission of sins.",
    },
  ],
  "trinity-of-god": [
    {
  ...
  "sacrament-of-matrimony": [
    ...
    {
      prompt: "Why does the lesson call marriage a sacrament and not only a civil contract?",
      options: [
        "Because earthly marriage is taken up into the Kingdom of God and sanctified by grace",
        "Because marriage has no spiritual meaning at all",
        "Because love is unnecessary in Christian marriage",
        "Because marriage exists only to satisfy society",
      ],
      answerIndex: 0,
      explanation: "The lesson says marriage is transformed from an earthly reality into a sanctified mystery belonging to the Kingdom.",
    },
    {
      prompt: "What Gospel event does the lesson connect to the sanctification of marriage?",
      options: [
      ...
      answerIndex: 0,
      explanation: "The lesson points to Christ's presence at Cana and His first miracle there as a sign of His blessing upon marriage.",
    },
    {
      prompt: "How does the lesson connect marriage to Ephesians 5?",
      options: [
        "Marriage reflects the mystery of Christ and His Church",
        "Marriage is only a legal contract for society",
        "Marriage is unrelated to salvation",
        "Marriage is presented as spiritually inferior by nature",
      ],
      answerIndex: 0,
      explanation: "The lesson treats Ephesians 5 as central for understanding Christian marriage as a holy mystery.",
    },
    {
      prompt: "Why does the lesson say Orthodox marriage cannot be reduced to romance alone?",
      options: [
        "Because its purpose includes sanctification, sacrifice, and a shared path to heaven",
        "Because affection has no place in marriage",
        "Because marriage exists only for public ceremony",
        "Because the Church denies companionship",
      ],
      answerIndex: 0,
      explanation: "The lesson raises marriage above mere feeling and places it within sacrifice, holiness, and salvation.",
    },
  ],
  "salvation-in-the-orthodox-concept": [
    {
    ...
    {
      prompt: "Which of the following does the lesson include within the path of salvation?",
      options: [
        "Faith, sacraments, repentance, endurance, and good works",
        "Faith alone with no sacramental life",
        "Knowledge alone without repentance",
        "A single emotional experience only",
      ],
      answerIndex: 0,
      explanation: "The lesson presents salvation as a living path that includes faith, the saving sacraments, repentance, endurance, and good works.",
    },
    {
      prompt: "Why does the lesson reject the idea that salvation is guaranteed without perseverance?",
      options: [
        "Because Scripture speaks of abiding, struggle, and finishing faithfully",
        "Because the Church denies grace",
        "Because baptism has no meaning",
        "Because no one can ever be saved",
      ],
      answerIndex: 0,
      explanation: "The lesson treats salvation as real grace that must be lived in faithfulness, not as a detached guarantee apart from endurance.",
    },
    {
      prompt: "Why does the lesson refuse to reduce salvation to a single past event?",
      options: [
        "Because Orthodox teaching speaks of being saved, being saved now, and hoping to be saved finally",
        "Because the Church denies that Christ has already saved anyone",
        "Because salvation is only about moral effort",
        "Because the sacraments have no part in salvation",
      ],
      answerIndex: 0,
      explanation: "The lesson presents salvation across the whole life: past, present, and future.",
    },
    {
      prompt: "What does the lesson say ties salvation to the life of the Church?",
      options: [
        "The saving sacraments, repentance, and perseverance in Christ",
        "Only private opinion",
        "Only historical interest",
        "Only intellectual agreement",
      ],
      answerIndex: 0,
      explanation: "The lesson makes salvation ecclesial and sacramental, not merely individual and abstract.",
    },
  ],
  "saints-intercession-veneration": [
    {
    ...
    {
      prompt: "What is the lesson's main reason for honoring the saints?",
      options: [
        "God Himself honors His saints, and the Church shares in that honor",
        "The saints replace Christ as savior",
        "The saints are remembered only as historical figures",
        "The Church believes holiness ends at death",
      ],
      answerIndex: 0,
      explanation: "The lesson says the Church honors the saints because God glorifies them and because they remain living members of Christ's body.",
    },
    {
      prompt: "How does the lesson distinguish veneration from worship?",
      options: [
        "Worship belongs to God alone, while saints are honored and asked to intercede",
        "Both are exactly the same",
        "Veneration belongs only to relics",
        "Worship may be offered to saints in a lesser way",
      ],
      answerIndex: 0,
      explanation: "The lesson carefully preserves worship for God alone while defending honor and intercession for the saints.",
    },
    {
      prompt: "Why does the lesson say the saints can still pray for the Church on earth?",
      options: [
        "Because they are alive in Christ and remain members of His one body",
        "Because death separates them completely from the Church",
        "Because only angels may pray in heaven",
        "Because Christ no longer intercedes",
      ],
      answerIndex: 0,
      explanation: "The lesson treats the saints as alive in Christ, not cut off from the Church after death.",
    },
    {
      prompt: "What does the lesson imply about relics and holy memorials?",
      options: [
        "They are honored because God's grace is shown through His saints",
        "They are worshiped as gods",
        "They are forbidden because matter is evil",
        "They have no link to the life of the Church",
      ],
      answerIndex: 0,
      explanation: "The lesson places relics and memorials within the Church's honor for the saints and God's grace in them.",
    },
  ],
  fasting: [
    {
    ...
    {
      prompt: "What does the lesson teach fasting should be joined to?",
      options: [
        "Prayer, repentance, and spiritual discipline",
        "Pride and self-display",
        "Food rules only",
        "Silence without worship",
      ],
      answerIndex: 0,
      explanation: "The lesson presents fasting as part of worship and spiritual struggle, not merely a food system.",
    },
    {
      prompt: "Why does the lesson reject the idea that fasting is optional?",
      options: [
        "Because Christ, Scripture, and the life of the Church all treat it as part of faithful Christian life",
        "Because only monks need discipline",
        "Because fasting is a cultural custom with no spiritual meaning",
        "Because salvation comes from hunger itself",
      ],
      answerIndex: 0,
      explanation: "The lesson argues from Scripture and church practice that fasting belongs to Christian worship and obedience.",
    },
  ],
  "works-and-faith": [
    {
    ...
    {
      prompt: "How does the lesson relate grace and human obedience?",
      options: [
        "The believer needs both the grace of God and a willing response in good works",
        "Grace makes obedience unnecessary",
        "Works save without grace",
        "Obedience is only for clergy",
      ],
      answerIndex: 0,
      explanation: "The lesson holds together God's grace and man's response rather than separating them.",
    },
    {
      prompt: "Why does the lesson reject the slogan of faith alone as sufficient?",
      options: [
        "Because Scripture calls for living obedience and not verbal belief by itself",
        "Because the Church rejects faith",
        "Because works replace Christ",
        "Because belief and conduct are unrelated",
      ],
      answerIndex: 0,
      explanation: "The lesson uses James and the words of Christ to argue that real faith must be active and obedient.",
    },
    {
      prompt: "What kind of works does the lesson describe as good?",
      options: [
        "Works pleasing to God, empowered by grace, and flowing from faith",
        "Works done only for praise from others",
        "Any action at all regardless of motive",
        "Only intellectual activity",
      ],
      answerIndex: 0,
      explanation: "The lesson does not treat good works as empty activism, but as grace-filled obedience that pleases God.",
    },
    {
      prompt: "Why does the lesson say verbal confession of faith by itself is not enough?",
      options: [
        "Because Christ and the Apostles call for obedience, not words alone",
        "Because speech itself is sinful",
        "Because doctrine does not matter",
        "Because only public charity counts",
      ],
      answerIndex: 0,
      explanation: "The lesson argues from Scripture that true faith must be embodied in obedient life.",
    },
    {
      prompt: "How does the lesson describe evil works?",
      options: [
        "As inward and outward actions that displease God and resist His will",
        "As only criminal acts punishable by the state",
        "As mistakes that do not affect spiritual life",
        "As actions done only by unbelievers",
      ],
      answerIndex: 0,
      explanation: "The lesson treats works morally and spiritually, not merely legally or socially.",
    },
  ],
}

export const churchTeachingSections: TeachingSection[] = [
  {
  ...
  {
    title: "The Introduction of Christianity",
    paragraphs: [
  ...
  {
    title: "Expansion and Consolidation of Christianity c. 350 to 650 A.D.",
    paragraphs: [
  ...
  {
    title: "Persecution and Religious Controversies",
    paragraphs: [
  ...
  {
    title: "The Period of Reorganization",
    paragraphs: [
